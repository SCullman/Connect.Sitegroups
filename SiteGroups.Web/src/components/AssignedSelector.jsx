        ...
        return (
            <GridCell className={styles.assignedSelector}>
                ...
                <GridCell columnSize={10} className="selector-controls">
                    <div href="" className="move-item single-right" onClick={()=>this.props.moveItemsRight()} dangerouslySetInnerHTML={{ __html: SvgIcons.ArrowRightIcon }}></div>
                    <div href="" className="move-item single-left" onClick={()=>this.props.moveItemsLeft()} dangerouslySetInnerHTML={{ __html: SvgIcons.ArrowLeftIcon }}></div>
                    <div href="" className="move-item double-right" onClick={()=>this.props.moveAll("right")} dangerouslySetInnerHTML={{ __html: SvgIcons.DoubleArrowRightIcon }}></div>
                    <div href="" className="move-item double-left" onClick={()=>this.props.moveAll("left")} dangerouslySetInnerHTML={{ __html: SvgIcons.DoubleArrowLeftIcon }}></div>
                </GridCell>
                <GridCell columnSize={45} className="selector-box">
